...
<body>
        ...
        <div class="carousel swiper-wrapper">
            ...
            <div class="carousel-item swiper-slide">
                ...
                <div class="carousel-caption">
                    ...
                    <button onclick="location.href='collections.html'">Learn More</button>
                </div>
            </div>
            <div class="carousel-item swiper-slide">
                ...
                <div class="carousel-caption">
                    ...
                    <button onclick="location.href='collections.html'">Browse Gifts</button>
                </div>
            </div>
        </div>
    ...
    <div class="why-choose-us">
        ...
        <div class="benefits-container">
            <div class="benefit-box">
                ...
                <p>Every box is carefully selected with premium products, ensuring a delightful surprise for you.</p>
            </div>
            <div class="benefit-box">
        ...
        <div class="testimonial-wrapper">
            <div class="testimonial-box">
                ...
                <div class="testimonial-content">
                    <h3>Lisa Wilson</h3>
                    <h5>Denver, CO</h5>
                    <p>Unboxing my 'Cozy Night In' box was an indulgent experience! The fluffy socks, rich gourmet hot
                        chocolate, and calming aromatherapy candle were exactly what I needed for a relaxing evening.
            ...
            <div class="testimonial-box">
                ...
                <div class="testimonial-content">
                    ...
                    <p>Unbox Surprise is my go-to for birthdays and holidays! They always have a box that perfectly fits
                        the recipient's interests, making gift-giving easy and special. No more stress about finding the
            ...
            <div class="testimonial-box">
                ...
                <div class="testimonial-content">
                    <h3>Alice Guo</h3>
                    <h5>Bambang, CH</h5>
                    <p>I had a question about customizing a box for my niece's birthday, and the Unbox Surprise customer
                        service team was fantastic! They were super helpful and patient, and helped me create the
                        perfect box for her. The gift was a hit, and the entire experience was wonderful. Thanks, Unbox
                        Surprise!</p>
                </div>
            </div>
        </div>
    ...
    <section class="how-it-works">
        ...
        <a href="collections.html" class="how-it-works-btn">See All Boxes</a>
    </section>
